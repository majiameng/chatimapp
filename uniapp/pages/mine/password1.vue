       ...
       <headerline shownav=true  isback="true" @tapnav="tapnav"   :navstyle="navstyle"  :navitem="navitem"  :navselect="navselect" :statusbarheight='statusBarHeight'  ></headerline>
         ...
         <view v-if="navselect==0">
                 ...
                 <ul class="profile" v-if="!isfrist" >
                      ...
                      <li>
                          <input type="password" id="password" v-model="pwd0"  style="width: 150px;" class="input1" placeholder="请输入原始资金密码"  />
              ...
              <ul class="profile" >
                  ...
                  <li>
                      <input type="password" id="password" v-model="pwd1" style="width: 150px;" class="input1" placeholder="请输入新资金密码"  />
              ...
              <ul class="profile" >
                   ...
                   <li>
                       <input type="password" id="password" v-model="pwd2" style="width: 150px;" class="input1" placeholder="再次输入新资金密码" oninput="checkpwd(this.value);" onblur="check_other(this.value,'password');check_other($('#password2').val(),'password1');" />
         ...
         <view v-else>
             <ul class="profile" >
                 ...
                 <ul class="profile" >
                     <li>新资金密码：</li>
                     <li><input type="password" class="input1" id="pwd" v-model="pwd" placeholder="输入新的资金密码" />
...
<script>
       ...
       data() {    
        ...
        methods: {
           ...
           change_pwd() {
                ...
                http.setWait(true).post('user.php?act=change_pwd',{method:'safe',id:this.user.id,password:this.pwd1,oldpwd:this.pwd0,isfrist:this.isfrist}).then(res=>{
  ...
  var mobile=this.mobile;
                    ...
                    http.setWait(true).post('user.php?act=reset_pwd',{id:this.user.id,mobile:mobile,randcode:this.randcode,pwd:this.pwd,method:'safe'}).then(res=>{
        ...
        onLoad(opts) {
            var pwd=this.user.pwd1;
           if(pwd==undefined || pwd==null || pwd=='' ){
               this.isfrist=true;
                this.navitem=['设置资金密码','忘记资金密码']
           }
           else {
               this.isfrist=false;
           }
